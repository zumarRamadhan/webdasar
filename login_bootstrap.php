...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> 
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-4 me-4 bd-mode-toggle"> <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Toggle theme (auto)"> <svg class="bi my-1 theme-icon-active" aria-hidden="true">
    ...
    <main class="form-signin w-100 m-auto border border-secondary rounded-5 p-3">
        <form id="loginForm">
            <div class="text-center">
                <img class="mb-4" src="logo.png" alt="" height="200">
            </div>
            <h1 class="h3 mb-3 fw-normal text-center">Masuk Sini Dulu Bro!</h1>
